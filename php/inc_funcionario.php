<div class="row justify-content-center align-items-center" style="margin-top:3%;">
	<div class="col col-sm col-md col-lg col-xl-9" style="background: #f0f0f0; padding:50px;">
		<form action="incluir.php"  method="GET">
			...
			<div class="form-group">
					Nome:<br>
					<input type="text"  name="nome_funcionario" placeholder="Nome" class="form-control" >
			</div>
			<div class="form-group">
				E-mail:<br>
				<input type="email"  name="email_funcionario" placeholder="E-mail" class="form-control" required="required">
			</div>
			<div class="form-group">
				Senha:<br>
			...
			<div class="form-group">
				...
				<input type="number"  name="id_funcional" placeholder="ID Funcional" class="form-control" >
			</div>	
			<div class="form-group">
				<div class="container">
					<div class="row">
